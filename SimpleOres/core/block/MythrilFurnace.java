...
public class MythrilFurnace extends BlockContainer
{
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            par5EntityPlayer.openGui(SimpleOres.mod, 0, par1World, par2, par3, par4);
    ...
    {
        return new TileEntityMythrilFurnace();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
            TileEntityMythrilFurnace tileentityfurnace = (TileEntityMythrilFurnace)par1World.getBlockTileEntity(par2, par3, par4);
