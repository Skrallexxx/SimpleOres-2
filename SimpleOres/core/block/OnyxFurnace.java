...
public class OnyxFurnace extends BlockContainer
{
    ...
    public OnyxFurnace(int par1, boolean par2)
    {
    ...
    {
        return Blocks.onyxFurnace.blockID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("simpleores:" + "onyxFurnaceSide");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleores:" + "onyxFurnaceFrontLit" : "simpleores:" + "onyxFurnaceFront");
        this.furnaceIconTop = par1IconRegister.registerIcon("simpleores:" + "onyxFurnaceTop");
    }
    ...
    public boolean onBlockActivated(World par1World, int par2, int par3, int par4, EntityPlayer par5EntityPlayer, int par6, float par7, float par8, float par9)
    {
        ...
        {
            TileEntityOnyxFurnace tileentityfurnace = (TileEntityOnyxFurnace)par1World.getBlockTileEntity(par2, par3, par4);
            par5EntityPlayer.openGui(mod.mod, 0, par1World, par2, par3, par4);
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Blocks.onyxFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Blocks.onyxFurnace.blockID);
        }
