...
public class OnyxFurnaceGUI extends GuiContainer
{
    ...
    {
        this.fontRenderer.drawString(StatCollector.translateToLocal("tile.onyxFurnace.name"), this.xSize / 2 - this.fontRenderer.getStringWidth(StatCollector.translateToLocal("tile.onyxFurnace.name")) / 2, 6, 4210752);
    }
