...
//======================================= CREATION ======================================================= 	
	...
	public static void doSettings(FMLPreInitializationEvent event)
    {
		...
		try 
	    {
        	...
        	if(enableToolStatModification)
        	{
        		...
        		bronzeUsesNum = settings.get("Tool Stats", "Bronze Uses Number", 400).getInt();
        		bronzeMiningSpeed = (float) settings.get("Tool Stats", "Bronze Mining Speed", 7.5).getDouble(bronzeMiningSpeed);
        		bronzeDamageVsEntity = settings.get("Tool Stats", "Bronze Damage Vs Entity", 2).getInt();
        		bronzeEnchantability = settings.get("Tool Stats", "Bronze Enchantability", 6).getInt();
        	...
        	if(enableArmorStatModification)
        	{
        		...
        		bronzeArmorEnchantability = settings.get("Armor Stats", "Bronze Armor Enchantability", 6).getInt();
	...
	public static void defaultToolStats()
	{
		bronzeMiningLevel = 2;
		bronzeUsesNum = 400;
		bronzeMiningSpeed = 7.5F;
		bronzeDamageVsEntity = 2;
		bronzeEnchantability = 6;
