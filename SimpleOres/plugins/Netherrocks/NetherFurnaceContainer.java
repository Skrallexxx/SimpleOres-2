...
{
    private NetherFurnaceTileEntity furnace;
    private int lastCookTime;
    private int lastBurnTime;
    private int lastItemBurnTime;

    public NetherFurnaceContainer(InventoryPlayer par1InventoryPlayer, NetherFurnaceTileEntity par2TileEntityFurnace)
    {
    ...
    public ItemStack transferStackInSlot(EntityPlayer par1EntityPlayer, int par2)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            else if (par2 != 1 && par2 != 0)
            {
                ...
                else if (NetherFurnaceTileEntity.isItemFuel(itemstack1))
                {
