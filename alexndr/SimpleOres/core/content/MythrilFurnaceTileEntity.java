...
public class MythrilFurnaceTileEntity extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                MythrilFurnace.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (par0ItemStack.getItem() instanceof ItemBlock && Block.getBlockFromItem(item) != Blocks.air)
            {
                ...
                {
                    return 16000 * Settings.mythrilFurnaceMultiplier;
                }
            }
            ...
            if (item instanceof ItemHoe && ((ItemHoe) item).getToolMaterialName().equals("WOOD")) return 200 * Settings.mythrilFurnaceMultiplier;
            if (item == Items.stick) return 100 * Settings.mythrilFurnaceMultiplier;
            if (item == Items.coal) return 1600 * Settings.mythrilFurnaceMultiplier;
            if (item == Items.lava_bucket) return 20000 * Settings.mythrilFurnaceMultiplier;
            if (item == Item.getItemFromBlock(Blocks.sapling)) return 100 * Settings.mythrilFurnaceMultiplier;
            if (item == Items.blaze_rod) return 2400 * Settings.mythrilFurnaceMultiplier;
