...
public class OnyxFurnace extends BlockContainer
{
    ...
    public OnyxFurnace(boolean par2)
    {
        super(Material.rock);
        this.isActive = par2;
		this.setBlockTextureName("simpleores:" + this.getUnlocalizedName());
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("simpleores:" + "onyx_furnace_side");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleores:" + "onyx_furnace_front_lit" : "simpleores:" + "onyx_furnace_front");
        this.furnaceIconTop = par1IconRegister.registerIcon("simpleores:" + "onyx_furnace_top");
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Content.onyx_furnace_lit);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Content.onyx_furnace);
        }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        ...
        {
            OnyxFurnaceTileEntity tileentityfurnace = (OnyxFurnaceTileEntity)par1World.getTileEntity(par2, par3, par4);
