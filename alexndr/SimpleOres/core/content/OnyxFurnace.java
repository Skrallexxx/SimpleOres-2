...
public class OnyxFurnace extends BlockContainer
{
    ...
    {
        return Content.onyxFurnace.blockID;
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Content.onyxFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Content.onyxFurnace.blockID);
        }
