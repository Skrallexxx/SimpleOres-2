...
public class FFurnaceTileEntityTin extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                FFurnaceTin.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
