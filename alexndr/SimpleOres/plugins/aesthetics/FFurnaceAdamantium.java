...
public class FFurnaceAdamantium extends BlockContainer
{
    ...
    public FFurnaceAdamantium(int par1, boolean par2)
    {
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("aestheticsplugin:fusionFurnaceSideAdamantium");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "aestheticsplugin:fusionFurnaceFrontLitAdamantium" : "aestheticsplugin:fusionFurnaceFrontAdamantium");
        this.furnaceIconTop = par1IconRegister.registerIcon("aestheticsplugin:fusionFurnaceTopAdamantium");
    }
    ...
    {
        return new FFurnaceTileEntityAdamantium();
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, int par5, int par6)
    {
        ...
        {
        	FFurnaceTileEntityAdamantium tileentityfurnace = (FFurnaceTileEntityAdamantium)par1World.getBlockTileEntity(par2, par3, par4);
