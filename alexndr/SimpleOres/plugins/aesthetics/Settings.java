...
public class Settings 
{
	public static void doSettings(FMLPreInitializationEvent event)
	{
    	...
    	try
    	{
			...
			enableSimpleOresContent = settings.get("Toggles", "Enable SimpleOres Core Content? (SimpleOres must still be installed)", true).getBoolean(enableSimpleOresContent);
    		...
    		LogHelper.verboseInfo("Aesthetics Plugin: Successfully loaded settings file at: '" + settingsFile.getAbsolutePath() + "'.");
    	}
    	catch(Exception e)
    	{
	...
	public static boolean enableSimpleOresContent, enableFusionContent, enableNetherrocksContent;
