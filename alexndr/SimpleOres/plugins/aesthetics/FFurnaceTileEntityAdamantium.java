...
public class FFurnaceTileEntityAdamantium extends TileEntity implements ISidedInventory
{
    ...
    public void updateEntity()
    {
        ...
        if (!this.worldObj.isRemote)
        {
            ...
            {
                flag1 = true;
                FFurnaceAdamantium.updateFurnaceBlockState(this.furnaceBurnTime > 0, this.worldObj, this.xCoord, this.yCoord, this.zCoord);
            }
        }
    ...
    public static int getItemBurnTime(ItemStack par0ItemStack)
    {
        ...
        else
        {
            ...
            if (par0ItemStack.getItem() instanceof ItemBlock && Block.blocksList[i] != null)
            {
                ...
                {
                    return 150 * (int) 1.875 / 2;
                }

                if (block.blockMaterial == Material.wood)
                {
                    return 300 * (int) 1.875 / 2;
                }
                
                if (block == Block.coalBlock)
                {
                    return 16000 * (int) 1.875 / 2;
                }
            }

            if (item instanceof ItemTool && ((ItemTool) item).getToolMaterialName().equals("WOOD")) return 200 * (int) 1.875 / 2;
            if (item instanceof ItemSword && ((ItemSword) item).getToolMaterialName().equals("WOOD")) return 200 * (int) 1.875 / 2;
            if (item instanceof ItemHoe && ((ItemHoe) item).getMaterialName().equals("WOOD")) return 200 * (int) 1.875 / 2;
            if (i == Item.stick.itemID) return 200 * (int) 1.875 / 2;
            if (i == Item.coal.itemID) return 1600 * (int) 1.875 / 2;
            if (i == Item.bucketLava.itemID) return 20000 * (int) 1.875 / 2;
            if (i == Block.sapling.blockID) return 100 * (int) 1.875 / 2;
            if (i == Item.blazeRod.itemID) return 2400 * (int) 1.875 / 2;
            return GameRegistry.getFuelValue(par0ItemStack) * (int) 1.875 / 2;
        }
    }
