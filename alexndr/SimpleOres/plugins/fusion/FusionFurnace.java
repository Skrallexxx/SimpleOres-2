...
public class FusionFurnace extends BlockContainer
{
    ...
    public FusionFurnace(int par1, boolean par2)
    {
    ...
    {
        return Content.fusionFurnace.blockID;
    }
    ...
    {
        this.blockIcon = par1IconRegister.registerIcon("simpleoresfusion:fusionFurnaceSide");
        this.furnaceIconFront = par1IconRegister.registerIcon(this.isActive ? "simpleoresfusion:fusionFurnaceFrontLit" : "simpleoresfusion:fusionFurnaceFront");
        this.furnaceIconTop = par1IconRegister.registerIcon("simpleoresfusion:fusionFurnaceTop");
    }
    ...
    public static void updateFurnaceBlockState(boolean par0, World par1World, int par2, int par3, int par4)
    {
        ...
        if (par0)
        {
            par1World.setBlock(par2, par3, par4, Content.fusionFurnaceOn.blockID);
        }
        else
        {
            par1World.setBlock(par2, par3, par4, Content.fusionFurnace.blockID);
        }
