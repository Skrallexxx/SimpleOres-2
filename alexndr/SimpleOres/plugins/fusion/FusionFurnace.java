...
public class FusionFurnace extends BlockContainer
{
    ...
    public FusionFurnace(boolean par2)
    {
        super(Material.rock);
        this.isActive = par2;
    ...
    {
        this.blockIcon = par1IIconRegister.registerIcon("simpleoresfusion:fusion_furnace_side");
        this.furnaceIconFront = par1IIconRegister.registerIcon(this.isActive ? "simpleoresfusion:fusion_furnace_front_lit" : "simpleoresfusion:fusion_furnace_front");
        this.furnaceIconTop = par1IIconRegister.registerIcon("simpleoresfusion:fusion_furnace_top");
    }
    ...
    public void breakBlock(World par1World, int par2, int par3, int par4, Block par5, int par6)
    {
        ...
        {
            FusionFurnaceTileEntity tileentityfurnace = (FusionFurnaceTileEntity)par1World.getTileEntity(par2, par3, par4);
